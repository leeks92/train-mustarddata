...
import { getItxRoute, getItxRoutes, getStations, formatCharge, getValidMinCharge, getValidMaxCharge } from '@/lib/data';
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: `${depName} → ${arrName} ITX 시간표 - 요금, 소요시간`,
    description: `${route.depStationName}에서 ${route.arrStationName} 가는 ITX 시간표. ${route.schedules.length}회 운행${chargeText}.`,
    keywords: [
      `${depName} ${arrName} ITX`,
    ...
    openGraph: {
      title: `${depName} → ${arrName} ITX 시간표`,
      description: `${route.depStationName}에서 ${route.arrStationName} 가는 ITX. ${route.schedules.length}회/일 운행${chargeText}.`,
