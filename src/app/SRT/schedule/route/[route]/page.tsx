...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: `${route.depStationName}에서 ${route.arrStationName} 가는 SRT 시간표 - 요금, 소요시간`,
    description: `${route.depStationName}에서 ${route.arrStationName} 가는 SRT 시간표. ${route.schedules.length}회 운행${timeText}${chargeText}.`,
    keywords: [
      `${depName} ${arrName} SRT`,
      `${depName} ${arrName} 기차`,
    ...
    openGraph: {
      title: `${route.depStationName}에서 ${route.arrStationName} 가는 SRT 시간표`,
      description: `${route.depStationName}에서 ${route.arrStationName} 가는 SRT. ${route.schedules.length}회/일 운행${timeText}${chargeText}.`,
    ...
    <div className="max-w-6xl mx-auto px-4 py-8">
      ...
      <header className="bg-gradient-to-r from-purple-600 to-purple-700 text-white rounded-xl p-6 mb-8">
        ...
        <h1 className="text-2xl md:text-3xl font-bold mb-4">
          {route.depStationName}에서 {route.arrStationName} 가는 SRT 시간표
        </h1>
      ...
      <section className="bg-white rounded-xl shadow overflow-hidden">
        <div className="p-4 border-b bg-gray-50">
          <h2 className="text-lg font-bold text-gray-900">{route.depStationName} → {route.arrStationName} SRT 전체 시간표</h2>
        </div>
      ...
      <section className="mt-8">
        <h2 className="text-xl font-bold mb-4">{route.depStationName} → {route.arrStationName} SRT 요금 안내</h2>
      ...
      {schedules.length >= 3 && (
        <section className="mt-8 bg-white border border-gray-200 rounded-xl p-6">
          <h2 className="text-xl font-bold mb-4 text-gray-900">{route.depStationName} → {route.arrStationName} SRT 시간대별 운행</h2>
      ...
      {/* FAQ 섹션 */}
      <section className="mt-8">
        <h2 className="text-xl font-bold mb-4">{route.depStationName} → {route.arrStationName} SRT 자주 묻는 질문</h2>
